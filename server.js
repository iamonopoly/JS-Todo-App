...
let Estring =
    "mongodb+srv://todoAppUser:sam123456789@cluster0.bbsfn.mongodb.net/TodoApp?retryWrites=true&w=majority";
...
myApp.post("/create-item", function(req, res) {
    db.collection("todo").insertOne({ text: req.body.item }, function() {
